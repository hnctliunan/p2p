...
//		}
	...
	public boolean modelBaseRecordClassGenerated(TopLevelClass topLevelClass,IntrospectedTable introspectedTable) {
		...
		if(null == col){
			topLevelClass.addImportedType("com.base.entity.BaseSimpleEntity");
			topLevelClass.setSuperClass("BaseSimpleEntity");
		}else{
			topLevelClass.addImportedType("com.base.entity.BaseEntity");
